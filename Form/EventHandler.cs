...
namespace AddOne.Framework.Form
{
    public static class EventHandler
    {
        ...
        public static _IGridEvents_PressedAfterEventHandler ExceptionHandler(this _IGridEvents_PressedAfterEventHandler eventTrigger, AddOneFormBase form)
        {
        ...
        public static _IColumnEvents_ComboSelectAfterEventHandler ExceptionHandler(this _IColumnEvents_ComboSelectAfterEventHandler eventTrigger, AddOneFormBase form)
        {
        ...
        public static _IButtonEvents_ClickBeforeEventHandler ExceptionHandler(this _IButtonEvents_ClickBeforeEventHandler eventTrigger, AddOneFormBase form)
        {
        ...
        public static _IButtonComboEvents_ClickAfterEventHandler ExceptionHandler(this _IButtonComboEvents_ClickAfterEventHandler eventTrigger, AddOneFormBase form)
        {
