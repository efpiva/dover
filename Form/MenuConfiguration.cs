...
namespace Dover.Framework.Form
{
    ...
    [Menu(FatherUID = "43523", i18n = "Dover.Framework.Form.Messages.LicenseMenu", Type = BoMenuType.mt_STRING, UniqueID = "doverLicense", ValidateMethod = "IsSuperUser", Position = 6)]
